...
import time
import pygame
import pigpio #Added for Weapon Motor

#The lines below are for Weapon Motor
MAXSPEED = 100
weapon_pin = 20
weapon_freq = 500
pi1 = pigpio.pi()
...
#The lines above are for Weapon Motor
...
#    motors.motor1.setSpeed(int(r_trig))
    ...
    duty_cycle = int((r_trig*25)+75)                #weapon motor
    pi1.set_PWM_dutycycle(weapon_pin,duty_cycle)    #weapon motor
